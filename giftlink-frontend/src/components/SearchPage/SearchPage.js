...
function SearchPage() {
    ...
    const handleSearch = async () => {
        ...
        const queryParams = new URLSearchParams({
                name: searchQuery, age_years: ageRange,
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error('The search has failed.');
                }
                const data = await response.json();
                setSearchResults(data);
            } catch (error) {
                console.error('Unable to fetch results of search:', error);
            }
        };
            ...
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    <div className="search-results mt-4">
                        ...
                        <div className = "alert alert-info product-alert" role="alert">
